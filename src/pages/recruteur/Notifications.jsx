...
const ICONS = {
  ...
  SYSTEME: { icon: <FiBell size={15} />, color: 'var(--muted)', bg: 'var(--border-light)' },
};
...
export default function RecruteurNotifications() {
  const { user } = useAuth();
      ...
      <div className="rp-header">
        <div className="rp-header__top">
          <div>
            ...
            <p className="rp-subtitle">Toutes les alertes liées à vos offres et candidatures</p>
          </div>
          {hasUnread && (
