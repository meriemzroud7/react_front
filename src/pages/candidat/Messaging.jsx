...
const TEMPLATES = [
  "Bonjour, je vous remercie pour votre retour concernant ma candidature.",
  "Je suis très intéressé(e) par le poste, seriez-vous disponible pour un entretien ?",
  "Merci de m'avoir reçu(e) en entretien, je reste à votre disposition pour la suite.",
  "Pourriez-vous me préciser les prochaines étapes du processus de recrutement ?",
];
...
export default function Messaging() {
  ...
  // ---- chargement initial des conversations + enrichissement (nom/avatar du recruteur) ----
  useEffect(() => {
  ...
  // ---- ouvre le panneau "nouveau message" et charge tous les utilisateurs ----
            ...
            {showNewChat ? (
              <>
                ...
                {!loadingUsers && allUsers.length === 0 && (
                  <div style={{ padding: '1rem', fontSize: '0.8rem', color: 'var(--muted)' }}>Aucun utilisateur trouvé.</div>
                )}
              </>
            ) : (
              conversations.map((c) => (
